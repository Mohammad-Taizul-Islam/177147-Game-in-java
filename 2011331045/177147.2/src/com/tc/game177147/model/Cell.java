package com.tc.game177147.model;
    ...
    private Color getTileColor() {
        ...
        switch (value) {
            ...
            case 6:     color = Color.WHITE;
                        break;
            case 12:     color = new Color(255, 255, 170);
                        break;
            case 24:    color = new Color(255, 255, 128);
                        break;
            case 48:    color = new Color(255, 255, 85);
                        break;
            case 729:    color = new Color(255, 255, 43);
                        break;
            case 2187:   color = new Color(255, 255, 0);
                        break;
            case 6561:   color = new Color(213, 213, 0);
                        break;
            case 19683:   color = new Color(170, 170, 0);
                        break;
            case 59049:  color = new Color(128, 128, 0);
                        break;
            case 177147:  color = new Color(85, 85, 0);
                        break;
